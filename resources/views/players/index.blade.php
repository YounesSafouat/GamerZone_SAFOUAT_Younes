                    ...
                    <ul class="divide-y divide-gray-200">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <span
                                                        class="text-white font-bold">{{ substr($player->user->name, 0, 1) }}</span>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">Game: {{ $player->game_username }}
                                                    ({{ $player->game_type }})</div>
                                                <div class="mt-1 text-xs text-gray-500">
                                                    Tournament: {{ $player->tournament->name ?? 'Not registered' }}
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @empty
                            <li class="px-4 py-8 text-center text-gray-500">
                                No players found. <a href="{{ route('players.create') }}"
