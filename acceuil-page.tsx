          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className="px-4 py-2 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-100 shadow-lg">
                  <span className="text-lg font-bold text-gray-600">OU</span>
                </div>
              </div>
